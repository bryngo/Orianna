...
public abstract class StaticDataAPI {
    private static Set<Long> IGNORE_ITEMS = new HashSet<>(Arrays.asList(new Long[] {0L, 1080L, 1300L, 1301L, 1303L, 1304L,
            1305L, 1306L, 1307L, 1308L, 1309L, 1310L, 1311L, 1312L, 1313L, 1314L, 1315L, 1316L, 1317L, 1318L, 1319L, 1320L,
            1321L, 1322L, 1323L, 1324L, 1325L, 1326L, 1327L, 1328L, 1329L, 1330L, 1332L, 1331L, 1333L, 1334L, 1403L, 1415L, 2004L, 2037L,
            2039L, 2040L, 2041L, 2043L, 3005L, 3023L, 3039L, 3123L, 3128L, 3131L, 3160L, 3166L, 3167L, 3168L, 3169L, 3175L,
            3176L, 3171L, 3172L, 3186L, 3188L, 3205L, 3206L, 3207L, 3209L, 3210L, 3244L, 3342L, 3405L, 3406L, 3407L, 3408L,
            3409L, 3410L, 3411L, 3412L, 3413L, 3414L, 3415L, 3416L, 3417L, 3419L, 3420L, 3707L, 3708L, 3709L, 3710L, 3713L, 3717L, 3716L, 3720L, 3722L, 3723L,
            3724L, 3725L, 3930L, 3931L, 3932L, 3933L}));
